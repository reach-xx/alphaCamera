...
/*VPSS通道定义*/
#define VPSS_4K_CHN       1    /*该通道为4K 缩放为1080P全景通道*/
#define VPSS_CROP_EXTCHN  4    /*该通道为crop的扩展通道*/
#define VPSS_CROP_CHN     2    /*该通道为4K中裁剪分辨率通道*/

#define VPSS_TRACK_CHN    3    /*跟踪分析通道缩放为360P*/
...
HI_S32 SAMPLE_COMM_ISP_Init(ISP_DEV IspDev, WDR_MODE_E  enWDRMode, SAMPLE_FRAMERATE_E enFrmRate);
