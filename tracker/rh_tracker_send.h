...
typedef struct _SysParamsV2
{
	...
	char  strCodeVer[8];    //
	BYTE bVmode;		//ÊÓÆµÄ£Ê½    0 ------- D1  1 ------CIF   2------4CIF 
...
typedef struct _DataHeader
{
	...
	WORD    biBitCount;							//VGA£ºBitCount	Audio£ºChannel
	DWORD   fccCompressedHandler;				//VGA£ºmmioFOURCC (¡®H¡¯,¡¯2¡¯,¡¯6¡¯,¡¯4¡¯)
											    //Audio£ºmmioFOURCC(¡®A¡¯,¡¯D¡¯,¡¯T¡¯,¡¯S¡¯)
	DWORD   fccHandler;	   						//Audio£ºSampleBit
