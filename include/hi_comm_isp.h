...
typedef struct hiISP_WB_STATISTICS_CFG_PARA_S
{
    ...
    HI_U16 u16BlackLevel;       /*RW, Lower limit of valid data for white region, Range: [0x0, u16WhiteLevel]. This parameter defines the value above sensor offset, logic limit = u16BlackLevel + offset */
